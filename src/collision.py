...
def how_many_before_collision(buckets, loops=1):
    '''
    Roll random hash indexes into buckets and print how many rolls
    before a hash collision
...
def longest_link_list_chain(keys, buckets, loops = 10):
    '''
    Rolls keys number of random keys into buckets buckets and count 
    the collisions
...
longest_link_list_chain(16, 16, 10)
